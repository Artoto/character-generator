...
export default function ViewImage({ imageUrl, onClose }: ViewImageProps) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50">
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  p-6 w-[95%] md:w-7xl h-full rounded-lg shadow-lg z-60 text-center flex items-center justify-center">
        <button
